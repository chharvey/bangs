...
const DOCS = new Page({ name: 'Bangs!', url: '/docs/' })
  ...
  .add(new Page({ name: 'Properties', url: '/docs/props.html' })
    ...
    .add(new Page({ name: 'Text Cosmetics', url: '/docs/props.html#ss-text-cosmetics' })
      ...
      .add(new Page({ name: 'text-decoration-style', url: '/docs/props.html#text-decoration-style' }))
      .add(new Page({ name: 'text-decoration-color', url: '/docs/props.html#text-decoration-color' }))
