...
fs.mkdir('build/', function (err, data) {
  fs.writeFile(`${__dirname}/../build/_width.less`                , Bangs.generateTrackFracs ('width'                                                      ), function (err, data) { if (err) throw err })
  fs.writeFile(`${__dirname}/../build/_flex.less`                 , Bangs.generateTrackFracs ('flex'                                                       ), function (err, data) { if (err) throw err })
